...
define( 'WPGPYT_BASENAME_FILE', plugin_basename( __FILE__ ) );
...
require_once plugin_dir_path( __FILE__ ) . 'admin/wpgp-framework/metabox/appearance.php';
require_once plugin_dir_path( __FILE__ ) . 'admin/wpgp-framework/metabox/controls.php';
require_once plugin_dir_path( __FILE__ ) . 'admin/wpgp-framework/metabox/colors.php';
